from app.models.objective.tsp.mapper import TravelingSalesmanProblemObjectiveMapper
...
class TravelingSalesmanProblemMapper(ProblemMapper):
    ...
    def to_dto(obj: TravelingSalesmanProblem) -> TravelingSalesmanProblemOutputDTO:
        objectives = [TravelingSalesmanProblemObjectiveMapper.to_dto(objective) for objective in obj.objectives]
        tours = [TourMapper.to_dto(tour) for tour in obj.result_tours]
    ...
    def from_dto(dto: TravelingSalesmanProblemInputDTO) -> TravelingSalesmanProblem:
        objectives = [TravelingSalesmanProblemObjectiveMapper.from_dto(objective) for objective in dto.objectives]
