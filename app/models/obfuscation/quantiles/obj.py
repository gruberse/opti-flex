...
def test():
    obfuscation = QuantilesObfuscation(quantiles=3)
    ...
    assert estimated_fitness_list[3].estimated_fitness == 0
    assert estimated_fitness_list[4].estimated_fitness == 0
    assert estimated_fitness_list[5].estimated_fitness == 0
    assert estimated_fitness_list[6].estimated_fitness == -100
    assert estimated_fitness_list[7].estimated_fitness == 0
