...
class NSGA2basedTournamentSelection(NSGA2basedTournamentSelectionBase, Selection):

    def select_individuals(self, individuals: List[NSGA2Individual], n_individuals: int) -> List[Individual]:
        ...
        if not isinstance(individuals[0], NSGA2Individual):
            raise RuntimeError('nsga2 based tournament selection can only be used together with nsga2 based environmental selection')
