...
from app.models.solver.ga.parent_selection.nsga2_tournament.mapper import NSGA2TournamentSelectionMapper
...
class ParentSelectionMapperRegistry:
    _mapper_registry: dict[str, BaseMapper] = {
        ...
        "nsga2_tournament": NSGA2TournamentSelectionMapper,
    }
