...
from app.models.solver.ga.evaluation_mode.registry import EvaluationModeMapperRegistry
...
class GeneticAlgorithmMapper(BaseMapper):
    ...
    def to_dto(obj: GeneticAlgorithm) -> GeneticAlgorithmDTO:
        return GeneticAlgorithmDTO(
            ...
            evaluation_mode=EvaluationModeMapperRegistry.get_mapper(obj.evaluation_mode.evaluation_mode_type).to_dto(obj=obj.evaluation_mode),
    ...
    def from_dto(dto: GeneticAlgorithmDTO) -> GeneticAlgorithm:
        return GeneticAlgorithm(
            ...
            evaluation_mode=EvaluationModeMapperRegistry.get_mapper(dto.evaluation_mode.evaluation_mode_type).from_dto(dto=dto.evaluation_mode),
